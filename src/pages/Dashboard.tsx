...
const SESSIONS = [
  ...
  },
  {
    ...
    description: 'Build reusable AI skills and persistent projects — digital SOPs that produce consistent output every time.',
    icon: Bot,
    duration: '~90 min',
  },
  {
  ...
  },
  {
    ...
    description: 'Use AI features already built into the tools you use every day — spreadsheets, presentations, email.',
    icon: Zap,
    duration: '~60 min',
  },
  {
